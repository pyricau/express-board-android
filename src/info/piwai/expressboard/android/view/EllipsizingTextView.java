package info.piwai.expressboard.android.view;
...
/**
 * A {@link TextView} that has ellipsizing capability with multiline text
 * 
 * Based on <a href="https://github.com/triposo/barone">this GitHubproject</a>,
 * see <a href=
...
public class EllipsizingTextView extends TextView {
	...
	public interface EllipsizeListener {
		void ellipsizeStateChanged(EllipsizingTextView textView, boolean ellipsized);
	}
	...
	private Layout createWorkingLayout(String workingText) {
		return new StaticLayout(workingText, getPaint(), getWidth() - getPaddingLeft() - getPaddingRight(), Alignment.ALIGN_NORMAL, lineSpacingMultiplier, lineAdditionalVerticalPadding, false /* includepad */);
	}
